...
This script trains a LightGBM classifier to predict parking ticket locations
...
class ParkingTicketModelTrainer:
    ...
    def _compute_clusters(self, df: pd.DataFrame, eps: float = 0.003, min_samples: int = 50) -> np.ndarray:
        ...
        Args:
            ...
            eps: DBSCAN epsilon parameter (degrees)
    ...
    def train_model(self) -> lgb.LGBMClassifier:
        """Train LightGBM model with undersampling of the majority class."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train a parking ticket prediction model"
    )
    parser.add_argument(
        '--input_file',
        type=str,
